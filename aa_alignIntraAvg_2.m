...
template_average = dread([targetFolder_2{idx} '/average_ccFilt_Ex.em']);

% Need to apply transformation into original table
for idx = 1:noFilament
  sal = dalign(dynamo_bandpass(template_average,[1 23]), ...
  dynamo_bandpass(template_h,[1 23]),'cr',1,'cs',1,'ir',1,'is',1,'dim',96, 'limm',1,'lim',[1,1,20],'rf',5,'rff',2); % cone_flip
