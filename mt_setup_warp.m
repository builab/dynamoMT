%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Set up the project
% dynamoMT v0.1 (now working with Warp workflow)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
modDir = '/storage/builab/Thibault/20240905_SPEF1_MT_TS/warp_tiltseries/reconstruction/';
prjPath = '/storage/builab/Thibault/20240905_SPEF1_MT_TS/MTavg/';
modFileDelimiter = '*_MT.mod';
stringToBeRemoved = '_8.48Apx_MT.mod';
recSuffix = '_8.48Apx';
apixel = '8.48';
useWarpRec = 1;
...
if useWarpRec > 0
	pathToModelScript = fullfile(sprintf('%sdynamoMT', prjPath), 'vllAndDocScriptWarp.sh');
else
