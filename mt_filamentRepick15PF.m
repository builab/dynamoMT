...
% aa_alignAllParticles13PF.m or 15PF.m
% For 15 PF, the rise is 83.8, supertwist dphi is .685 degree
...
periodicity = 83.8; % Measured from yor average
boxSize = 80;
mw = 12;
subunits_dphi = 0.685;  % For the tip CP 0.72, baseCP 0.5, doublet 0
...
filamentListFile = sprintf('%sfilamentPFList15PF.csv', prjPath);
tableAlnFileName = 'merged_particles_twist_15PF_align.tbl'; % merge particles before particle alignment for robust but must be merged_particles_align to use doInitialAngle
