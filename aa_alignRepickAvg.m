...
for idx = 1:noFilament
	...
	if coneFlip > 0
		...
		sal = dalign(dynamo_bandpass(filamentAvg,[1 alnLowpassPix]), dynamo_bandpass(template,[1 alnLowpassPix]),'cr',9,'cs',3,'ir',15,'is',3,'dim', boxSize, 'limm',1,'lim',[5,5,zshift_limit],'rf',5,'rff',2); % cone_flip
