...
recSuffix = '_bin4_rec'; % Without the .mrc
tableAlnFileName = 'merged_particles_repick_align.tbl'; % merge particles after particle alignment for robust 
shiftVector = [0 0 0]; % Shift vector in pixel, measure from the map just like relion (-6 for Atubule, 10 for B-tubule)

outName = 'pf_center'; % Output will be name outName + tomoName + file extension
radius = 6;
